...
const DashboardPage = () => {
  ...
  // ALL FEATURES with role requirements
  const allFeatures = [
    { id: 1, name: 'Market Prediction', icon: TrendingUp, path: '/market-prediction', color: 'from-emerald-600/90 to-emerald-800/90', bgImage: marketBg, desc: 'Crop prices & trends', roles: ['farmer', 'both'] },
    { id: 2, name: 'Post a Job', icon: Briefcase, path: '/post-job', color: 'from-blue-600/90 to-blue-800/90', bgImage: labourBg, desc: 'Hire labour nearby', roles: ['farmer', 'both'] },
    { id: 3, name: 'Find Work', icon: Users, path: '/find-jobs', color: 'from-amber-600/90 to-amber-800/90', bgImage: labourBg, desc: 'Available jobs near you', roles: ['labour', 'both'] },
    { id: 4, name: 'Community', icon: MessageCircle, path: '/community-chat', color: 'from-purple-600/90 to-purple-800/90', bgImage: communityBg, desc: 'Chat with farmers', roles: ['farmer', 'labour', 'both'] },
    { id: 5, name: 'My Crops', icon: Sprout, path: '/my-crops', color: 'from-green-600/90 to-green-800/90', bgImage: cropsBg, desc: 'Track registered crops', roles: ['farmer', 'both'] },
    { id: 6, name: 'Labour Support', icon: Users, path: '/labour-support', color: 'from-orange-600/90 to-orange-800/90', bgImage: labourBg, desc: 'Find workers', roles: ['farmer', 'both'] },
    { id: 7, name: 'My Jobs', icon: Briefcase, path: '/my-jobs', color: 'from-indigo-600/90 to-indigo-800/90', bgImage: labourBg, desc: 'Manage posted jobs', roles: ['farmer', 'both'] },
    { id: 8, name: 'My Applications', icon: Users, path: '/my-applications', color: 'from-teal-600/90 to-teal-800/90', bgImage: labourBg, desc: 'Track applications', roles: ['labour', 'both'] },
    { id: 9, name: 'Weather', icon: Cloud, path: '/weather', color: 'from-cyan-600/90 to-cyan-800/90', bgImage: weatherBg, desc: 'Farming forecast', roles: ['farmer', 'labour', 'both'] },
    { id: 10, name: 'Profile', icon: User, path: '/profile', color: 'from-gray-600/90 to-gray-800/90', bgImage: null, desc: 'Your account', roles: ['farmer', 'labour', 'both'] }
  ];
  ...
  // Separate features for different sections
  const quickActions = features.slice(0, 4);
  ...
  return (
    <div className="min-h-screen bg-stone-50">
              ...
              <div className="relative p-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-emerald-100 capitalize">{userRole}</p>
      ...
      <div className="px-5 py-6 pb-24">
        {/* AI Insight Card - Only for Farmers */}
        ...
        {/* Market Summary Section - Only for Farmers */}
        {(userRole === 'farmer' || userRole === 'both') && (
          <div className="mb-8">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-t border-stone-200 shadow-lg">
        <div className="flex justify-around py-2 max-w-md mx-auto">
          ...
          {(userRole === 'labour' || userRole === 'both') && (
            <Link to="/find-jobs" className="flex flex-col items-center py-2 px-6 text-stone-400">
              <Briefcase size={22} />
